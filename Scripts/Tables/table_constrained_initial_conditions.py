...
def main():
    ...
    print(f"Initial Condition & {OE_0[0,0]} & {OE_0[0,1]} & {OE_0[0,2]} & {OE_0[0,3]} & {OE_0[0,4]} & {OE_0[0,5]} & {T_0} \\\\ \n \\hline ")
    ...
    for k in range(len(df)):
        ...
        print(f"{label} & {OE_0[0,0]} & {OE_0[0,1]} & {OE_0[0,2]} & {OE_0[0,3]} & {OE_0[0,4]} & {OE_0[0,5]} & {T_0_sol} \\\\ \n \\hline ")
    plt.show()
