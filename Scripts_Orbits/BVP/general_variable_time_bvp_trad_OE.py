...
from Scripts_Orbits.BVP.initial_conditions import not_periodic_IC
...
def main():
    ...
    lpe = LPE_Traditional(
        model.gravity_model, planet.mu, l_star=OE_0[0, 0], t_star=T, m_star=1.0
    ...
    constraint_angle_wrap_mask = [
        ...
        True,
        True,
    ]  # wrap w, Omega, M # [xf-x0]
    OE_0_sol, x_0_sol, T_sol = general_variable_time_bvp_trad_OE(
        T,
        OE_0,
        lpe,
